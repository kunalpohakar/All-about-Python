# Set
# Set is a unoreded collections of a unique objects.
...
print(my_set) # it returns only one 5 becoz it only retuns unique set 

# print(my_set[0]) # set obejct does not support indexing.
...
print(new_set)
print(my_set) # it retuns empty set
...
# .difference() : it shows a difference in between two stes
